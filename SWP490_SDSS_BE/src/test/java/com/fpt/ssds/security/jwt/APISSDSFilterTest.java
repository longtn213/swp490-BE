...
import com.fpt.ssds.management.SecurityMetersService;
import com.fpt.ssds.security.AuthoritiesConstants;
...
class APISSDSFilterTest {
    ...
    public void setup() {
        ...
        APIFilter = new ApiFilter(tokenProvider);
    ...
    void testJWTFilter() throws Exception {
        ...
        request.addHeader(APIFilter.AUTHORIZATION_HEADER, "Bearer " + jwt);
    ...
    void testJWTFilterMissingToken() throws Exception {
        MockHttpServletRequest request = new MockHttpServletRequest();
        request.addHeader(APIFilter.AUTHORIZATION_HEADER, "Bearer ");
        request.setRequestURI("/api/test");
        MockHttpServletResponse response = new MockHttpServletResponse();
        MockFilterChain filterChain = new MockFilterChain();
        APIFilter.doFilter(request, response, filterChain);
    ...
    void testJWTFilterWrongScheme() throws Exception {
        ...
        String jwt = tokenProvider.createToken(authentication, false);
        MockHttpServletRequest request = new MockHttpServletRequest();
        request.addHeader(APIFilter.AUTHORIZATION_HEADER, "Basic " + jwt);
        request.setRequestURI("/api/test");
        MockHttpServletResponse response = new MockHttpServletResponse();
        MockFilterChain filterChain = new MockFilterChain();
        APIFilter.doFilter(request, response, filterChain);
